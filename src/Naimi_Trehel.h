...
*/
    ...
    #define ENSURE_ERROR_NT(condition, fmt, ...) ensure_error(condition, fmr, ##__VA_ARGS__)
    #define ENSURE_WARNING_NT(condition, fmt, ...) ensure_warning(condition, fmr, ##__VA_ARGS__)
#else
    #define LOG_NT(fmt, ...)
